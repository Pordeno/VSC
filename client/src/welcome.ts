...
class WelcomePanel {
    ...
    #getHtmlForWebview = (webview: vscode.Webview) => {
        ...
        const scriptPath = Uri.joinPath(this.#mediaRoot,'welcome.js')
        const stylesPath = Uri.joinPath(this.#mediaRoot,'welcome.css')
        const logoPath = Uri.joinPath(this.#extensionUri,'deno.png')

        const denoExtension = vscode.extensions
            .getExtension(EXTENSION_ID)!

        const denoExtensionVersion =
            denoExtension.packageJSON.version;

        const scriptURI = webview
            .asWebviewUri(scriptPath)

        const stylesURI = webview
            .asWebviewUri(stylesPath)
                        ...
                        <div class = Header >
                            ...
                            <div class = Header-details >
                                ...
                                <h1 class = Header-title >
                                    Deno for VSCode v${ denoExtensionVersion }
                                </h1>

                                <p>
                                    The official Deno extension for
                                    Visual Studio Code, powered by
                                ...
                                <ul class = Header-links >
                                    <li>
                                        <a
                                            data-document = CHANGELOG.md
                                            data-command = openDocument
                                            class = Command
                                            href = #
                                        > Change Log </a>
                                    </li>
                                    <li>
                                        <a href = https://github.com/denoland/vscode_deno/>
                                            GitHub
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class = Card >
                                <div class = Card-inner >
                                    ...
                                    <p class = Card-content >
                                        ...
                                        <p>
                                            The extension does not assume it
                                            applies to all workspaces you use
                                            with VSCode. You can enable Deno
                                            in a workspace by running the
                                        ...
                                        <p>
                                            ...
                                            in the <a href="#" class="Command" data-command="openSetting" data-setting="deno.enable">settings</a>.
                            ...
                            <div class = Card >
                                <div class = Card-inner >
                                    ...
                                    <p class = Card-content >
                                        ...
                                        <a href="https://deno.land/manual/getting_started">getting started section</a>
                                        of the Deno manual.
                                    </p>
    ...
    static currentPanel : undefined | WelcomePanel
